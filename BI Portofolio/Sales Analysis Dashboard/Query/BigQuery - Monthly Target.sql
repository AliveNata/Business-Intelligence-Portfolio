WITH monthly_sales AS (
    ...
    JOIN `bi-dwh-intrepid.intrepid_dwh.dim_shop_info` dsi on fsd.shop_id = dsi.shop_id and fsd.venture = dsi.venture and fsd.order_created_date >= dsi.start_date and fsd.order_created_date <= dsi.end_date 
...
target_data AS (
    ...
    LEFT JOIN `bi-dwh-intrepid.intrepid_dwh.dim_acl` dal ON dtt.shop_id = dal.shop_id and dtt.venture = dal.venture
